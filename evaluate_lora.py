"""
Evaluate LoRA fine-tuned BLIP-2 checkpoint.

Usage:
  python evaluate_lora.py

Skips automatically if results/lora_results.json already exists.
Delete that file to force re-evaluation.
Requires: run lora.py first to produce checkpoints/lora/
"""
...
def main():
    ...
    model.eval()
    print(f"  Loaded LoRA weights from {CHECKPOINT_DIRS[METHOD]}/")
